...
DP_INC := -I../../../src/common -I../../../src/dp -I$(EZDK_BASE)dpe/dp/include -I$(EZDK_BASE)dpe/frame/include -I$(EZDK_BASE)dpe/sft/include -I$(EZDK_BASE)dpe/dpi/include

DP_C_SRCS = $(shell ls src/*.c)
