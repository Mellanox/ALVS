...
HOST_NUM_OF_IF_STATS = NW_NUM_OF_IF_STATS


NW_IF_STATS_POSTED_OFFSET = 0
REMOTE_IF_STATS_POSTED_OFFSET = NW_IF_STATS_POSTED_OFFSET + NW_IF_NUM * NW_NUM_OF_IF_STATS
HOST_IF_STATS_POSTED_OFFSET = REMOTE_IF_STATS_POSTED_OFFSET + REMOTE_IF_NUM * REMOTE_NUM_OF_IF_STATS
NW_POSTED_STATS_LAST_OFFSET = HOST_IF_STATS_POSTED_OFFSET + HOST_NUM_OF_IF_STATS
ALVS_ERROR_STATS_POSTED_OFFSET = NW_POSTED_STATS_LAST_OFFSET
...
SYSLOG_NUM_OF_COLOR_FLAG_STATS = 1
SYSLOG_TB_STATS_ON_DEMAND_OFFSET = 0
SYSLOG_NUM_OF_TB_STATS = 1

SYSLOG_COLOR_FLAG_STATS_ON_DEMAND_OFFSET = SYSLOG_TB_STATS_ON_DEMAND_OFFSET + SYSLOG_NUM_OF_TB_STATS
NW_ON_DENAMD_STATS_LAST_OFFSET = SYSLOG_COLOR_FLAG_STATS_ON_DEMAND_OFFSET + SYSLOG_NUM_OF_COLOR_FLAG_STATS
ALVS_SERVER_STATS_ON_DEMAND_OFFSET = NW_ON_DENAMD_STATS_LAST_OFFSET
