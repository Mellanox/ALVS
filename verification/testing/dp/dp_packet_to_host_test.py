...
if 2 in scenarios_to_run:
    ...
    data = '45 00 00 2e 00 00 40 00 40 11 2e b6 0a 07 7c 05 0a 07 7c 64 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 00 '
    temp_str = mac_da + ' ' + mac_sa + ether_type + data
    ...
    import pprint
    pprint.pprint(ezbox.get_interface_stats(0))
    pprint.pprint(ezbox.get_interface_stats(1))
    pprint.pprint(ezbox.get_interface_stats(2))
    pprint.pprint(ezbox.get_interface_stats(3))
    pprint.pprint(ezbox.get_interface_stats(4))
...
# #########################################################################################################
# ############################### scenario 5: not mac - send to host ######################################
# #########################################################################################################
