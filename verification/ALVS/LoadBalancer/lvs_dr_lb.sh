...
{
	cat <<EOF
Usage: $script_name [VIP] [BRDCAST] [NETMASK] [SCHD_ALGO] [S1_RIP] [S2_RIP]
...
Examples:
$script_name 192.168.1.100 192.168.1.254 255.255.255.0 rr 192.168.1.10 192.168.1.11
...
function setup_ipvs()
{
    ...
    #set up new virtual interface and bring it up
